        ...
        if '28' not in mat:
            ...
            for key in temp1.keys():
                if 'DE' in key:
                    ...
                    train_input.append(temp[-1].reshape(-1,6000)[:-10,:])
                    test_input.append(temp[-1].reshape(-1,6000)[-10:,:])
                    if 'B' in mat:
                        if '07' in mat:                           
                            train_output.append([0]*10)
                            test_output.append([0]*10)                            
                        if '14' in mat:
                            train_output.append([1]*10)
                            test_output.append([1]*10)                            
                        if '21' in mat:
                            train_output.append([2]*10)
                            test_output.append([2]*10)
                    if 'IR' in mat:
                        if '07' in mat:                           
                            train_output.append([3]*10)
                            test_output.append([3]*10)
                        if '14' in mat:
                            train_output.append([4]*10)
                            test_output.append([4]*10)
                        if '21' in mat:
                            train_output.append([5]*10)
                            test_output.append([5]*10)
                    if 'OR' in mat:
                        if '07' in mat:                           
                            train_output.append([6]*10)
                            test_output.append([6]*10)
                        if '14' in mat:
                            train_output.append([7]*10)
                            test_output.append([7]*10)
                        if '21' in mat:
                            train_output.append([8]*10)
                            test_output.append([8]*10)
...
def load_normal_data():
        ...
        for key in temp1.keys():
            if 'DE' in key:
                if 240000<len(temp1[key])<480000:
                    ...
                    train_input2.append(temp[-1].reshape(-1,6000)[:-20,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-20:,:])
                    
                if len(temp1[key])>480000:
                    temp.append(temp1[key][:480000])
                    train_input2.append(temp[-1].reshape(-1,6000)[:-40,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-40:,:])
    ...
    train_output2=np.ones((140,1))*9
    test_output2=np.ones((140,1))*9
