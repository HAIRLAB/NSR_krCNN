        ...
        if '28' not in mat:
            ...
            for key in temp1.keys():
                if 'DE' in key:
                    ...
                    train_input.append(temp[-1].reshape(-1,6000)[:-8,:])
                    test_input.append(temp[-1].reshape(-1,6000)[-8:,:])
                    if 'B' in mat:
                        if '07' in mat:                           
                            train_output.append([0]*12)
                            test_output.append([0]*8)                            
                        if '14' in mat:
                            train_output.append([1]*12)
                            test_output.append([1]*8)                            
                        if '21' in mat:
                            train_output.append([2]*12)
                            test_output.append([2]*8)
                    if 'IR' in mat:
                        if '07' in mat:                           
                            train_output.append([3]*12)
                            test_output.append([3]*8)
                        if '14' in mat:
                            train_output.append([4]*12)
                            test_output.append([4]*8)
                        if '21' in mat:
                            train_output.append([5]*12)
                            test_output.append([5]*8)
                    if 'OR' in mat:
                        if '07' in mat:                           
                            train_output.append([6]*12)
                            test_output.append([6]*8)
                        if '14' in mat:
                            train_output.append([7]*12)
                            test_output.append([7]*8)
                        if '21' in mat:
                            train_output.append([8]*12)
                            test_output.append([8]*8)
...
def load_normal_data():
        ...
        for key in temp1.keys():
            if 'DE' in key:
                ...
                if len(temp1[key])>480000:
                    ...
                    train_input2.append(temp[-1].reshape(-1,6000)[:-32,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-32:,:])
    ...
    train_output2=np.ones((168,1))*9
    test_output2=np.ones((112,1))*9
