        ...
        if '28' not in mat:
            ...
            for key in temp1.keys():
                if 'DE' in key:
                    ...
                    train_input.append(temp[-1].reshape(-1,6000)[:-6,:])
                    test_input.append(temp[-1].reshape(-1,6000)[-6:,:])
                    if 'B' in mat:
                        if '07' in mat:                           
                            train_output.append([0]*14)
                            test_output.append([0]*6)                            
                        if '14' in mat:
                            train_output.append([1]*14)
                            test_output.append([1]*6)                            
                        if '21' in mat:
                            train_output.append([2]*14)
                            test_output.append([2]*6)
                    if 'IR' in mat:
                        if '07' in mat:                           
                            train_output.append([3]*14)
                            test_output.append([3]*6)
                        if '14' in mat:
                            train_output.append([4]*14)
                            test_output.append([4]*6)
                        if '21' in mat:
                            train_output.append([5]*14)
                            test_output.append([5]*6)
                    if 'OR' in mat:
                        if '07' in mat:                           
                            train_output.append([6]*14)
                            test_output.append([6]*6)
                        if '14' in mat:
                            train_output.append([7]*14)
                            test_output.append([7]*6)
                        if '21' in mat:
                            train_output.append([8]*14)
                            test_output.append([8]*6)
...
def load_normal_data():
        ...
        for key in temp1.keys():
            if 'DE' in key:
                if 240000<len(temp1[key])<480000:
                    ...
                    train_input2.append(temp[-1].reshape(-1,6000)[:-12,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-12:,:])
                    
                if len(temp1[key])>480000:
                    temp.append(temp1[key][:480000])
                    train_input2.append(temp[-1].reshape(-1,6000)[:-24,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-24:,:])
    ...
    train_output2=np.ones((196,1))*9
    test_output2=np.ones((84,1))*9
