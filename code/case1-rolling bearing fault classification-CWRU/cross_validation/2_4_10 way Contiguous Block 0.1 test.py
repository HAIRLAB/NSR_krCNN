        ...
        if '28' not in mat:
            ...
            for key in temp1.keys():
                if 'DE' in key:
                    ...
                    train_input.append(temp[-1].reshape(-1,6000)[:-2,:])
                    test_input.append(temp[-1].reshape(-1,6000)[-2:,:])
                    if 'B' in mat:
                        if '07' in mat:                           
                            train_output.append([0]*18)
                            test_output.append([0]*2)                            
                        if '14' in mat:
                            train_output.append([1]*18)
                            test_output.append([1]*2)                            
                        if '21' in mat:
                            train_output.append([2]*18)
                            test_output.append([2]*2)
                    if 'IR' in mat:
                        if '07' in mat:                           
                            train_output.append([3]*18)
                            test_output.append([3]*2)
                        if '14' in mat:
                            train_output.append([4]*18)
                            test_output.append([4]*2)
                        if '21' in mat:
                            train_output.append([5]*18)
                            test_output.append([5]*2)
                    if 'OR' in mat:
                        if '07' in mat:                           
                            train_output.append([6]*18)
                            test_output.append([6]*2)
                        if '14' in mat:
                            train_output.append([7]*18)
                            test_output.append([7]*2)
                        if '21' in mat:
                            train_output.append([8]*18)
                            test_output.append([8]*2)
...
def load_normal_data():
        ...
        for key in temp1.keys():
            if 'DE' in key:
                if 240000<len(temp1[key])<480000:
                    ...
                    train_input2.append(temp[-1].reshape(-1,6000)[:-4,:])
                    test_input2.append(temp[-1].reshape(-1,6000)[-4:,:])
    ...
    train_output2=np.ones((252,1))*9
    test_output2=np.ones((28,1))*9
